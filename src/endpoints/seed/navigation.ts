...
export const navigationPied: NonNullable<Header['navItems']> = [
  { link: { type: 'custom', label: 'Qui sommes-nous', url: `${SITE}/a-propos/`, newTab: true } },
  {
    link: {
      type: 'custom',
      label: 'Politique de retour',
      url: `${SITE}/politique-de-retour/`,
      newTab: true,
    },
  },
  {
    link: { type: 'custom', label: 'Dictionnaire moto', url: `${SITE}/dictionnaire-moto/`, newTab: true },
  },
  { link: { type: 'custom', label: 'FAQ', url: `${SITE}/faq/`, newTab: true } },
  { link: { type: 'custom', label: 'CGVU', url: `${SITE}/cgv/`, newTab: true } },
